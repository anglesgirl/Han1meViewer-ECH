...
dependencies {
    // Generated by CI from anglesgirl/ech-proxy-go/mobile/echproxy.
    // Keep local developer builds usable before the AAR has been generated.
    ...
    // 统计改用 PostHog（自有域名 e.anglesya.win，大陆可直连）
